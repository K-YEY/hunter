<x-dashboard.layout.layout title="Dashboard">
    ...
    <x-dashboard.breadcrumb.breadcrumb title="Types" subTitle="Remember well that you will only live once."
        page="Types"></x-dashboard.breadcrumb.breadcrumb>
        <x-dashboard.searchbar.searchtable action="{{ route('admin.types.index') }}" value="{{ request()->input('search') }}" placeholder="Admins" ></x-dashboard.searchbar.searchtable>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="h6 modal-title">Delete <b>{{ $admin->name }}</b></h2>

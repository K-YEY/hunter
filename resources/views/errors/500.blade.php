<x-dashboard.layout.layout title="Error 500" bodyClass="" navbar="">
    ...
    <div class="container">
        <div class="row align-items-center ">
            <div class="col-12 col-lg-5 order-2 order-lg-1 text-center text-lg-left">
                ...
                <a href="javascript:history.back()" class="btn btn-gray-800 d-inline-flex align-items-center justify-content-center mb-4">
            ...
            <div class="col-12 col-lg-7 order-1 order-lg-2 text-center d-flex align-items-center justify-content-center">
                <img class="img-fluid w-75" src="{{asset('assets-dashboard/assets/img/illustrations/500.svg')}}" alt="500 Server Error">
            </div>
        </div>
    </div>
</section>
